...
const FaqModal = ({data}) => {
  ...
  return (
    <>
      <button
        onClick={toggleModal}
        className="block w-1/3 my-1 bg-gray-500 hover:bg-gray-700 m-auto text-white focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center"
        type="button">
       {data==='second'?'Second Photo':'First Photo'}
      </button>
